...
<form method="POST" action="{{ $action }}" class="space-y-6" data-place-form="true" enctype="multipart/form-data">
    ...
    <div class="flex justify-end space-x-3">
        ...
        <button type="submit"
            class="inline-flex items-center rounded-md border border-gray-500 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:border-gray-700">
