<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-breeze.nav-link :href="route('places.index')" :active="request()->routeIs('places.*')">
                        {{ __('Places') }}
                    </x-breeze.nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="uppercase text-gray-700 hover:text-gray-900">Log in</a>
                        <a href="{{ route('register') }}" class="uppercase text-gray-700 hover:text-gray-900">Register</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-breeze.responsive-nav-link :href="route('places.index')" :active="request()->routeIs('places.*')">
                {{ __('Places') }}
