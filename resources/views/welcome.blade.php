        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-gray-50: oklch(.962 .018 272.314);
                    --color-gray-100: oklch(.93 .034 272.788);
                    --color-gray-200: oklch(.87 .065 274.039);
                    --color-gray-300: oklch(.785 .115 274.713);
                    --color-gray-400: oklch(.673 .182 276.935);
                    --color-gray-500: oklch(.585 .233 277.117);
                    --color-gray-600: oklch(.511 .262 276.966);
                    --color-gray-700: oklch(.457 .24 277.023);
                    --color-gray-800: oklch(.398 .195 277.366);
                    --color-gray-900: oklch(.359 .144 278.697);
                    --color-gray-950: oklch(.257 .09 281.288);
